...
{
public:
    enum { IDD = IDD_SCWIZARD1 };

    CSnapshotWizardPage1(ATL::_U_STRINGorID title = (LPCTSTR)NULL)
	...
	void SetSharedString(wchar_t* sharedStringPage1){ sharedStringPage1_ = sharedStringPage1;}
...
{
public:
    enum { IDD = IDD_SCWIZARD2 };

    CSnapshotWizardPage2(ATL::_U_STRINGorID title = (LPCTSTR)NULL)
    ...
    BOOL OnSetActive();
	void SetSharedString(wchar_t* sharedStringPage2){ sharedStringPage2_ = sharedStringPage2;}
...
{
public:
    CSnapshotWizard(ATL::_U_STRINGorID title = (LPCTSTR)NULL,
        UINT uStartPage = 0, HWND hWndParent = NULL);

	~CSnapshotWizard(){ delete sharedString_; }
	...
	wchar_t* GetSnapshotFilePath(){ return sharedString_; }
